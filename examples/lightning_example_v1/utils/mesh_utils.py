...
from monarch.actor import ProcMesh, enable_transport, HostMesh
from utils.ip_utils import check_ips_available, create_tcp_addresses, get_master_ips
from monarch import Extent
...
def create_proc_mesh(allocator, alloc, num_nodes=2, num_gpus=8):
    """
    ...
    # proc_mesh = ProcMesh.from_alloc(allocator, alloc)
    return proc_mesh
...
def setup_proc_mesh_from_job(
    ...
    proc_mesh = create_proc_mesh(allocator, alloc, num_nodes, num_gpus)
